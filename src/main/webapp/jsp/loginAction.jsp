...
<body>
  <header>
    <div class="menu-container">
      ...
      <nav id="navMenu" class="nav-menu">
        ...
        <a href="hobbyInfo.jsp">취미 정보</a>
        <a href="reserve.jsp">예약하기</a>
        <a href="reservationCheck.jsp">예약 조회</a>
        <a href="popularHobbies.jsp">인기 취미 생활</a>
      </nav>
    </div>
    <h1 class="clickable" onclick="window.location.href='loginAction.jsp';">RE:JOY</h1>
    <div>
  ...
  <div class="container">
    ...
    <div class="button-grid">
      <button class="button" onclick="location.href='hobbyInfo.jsp'">취미 정보</button>
      <button class="button" onclick="location.href='reserve.jsp'">예약하기</button>
      <button class="button" onclick="location.href='reservationCheck.jsp'">예약 조회</button>
      <button class="button" onclick="location.href='popularHobbies.jsp'">인기 취미 생활</button>
    </div>
  </div>
</body>
</html>
